...
{
    class WindowsPhone : MobilePhone
    {
        public WindowsPhone(string make, string model, DateTime releasedDate, decimal originalValue, Condition condition, OpSystem operatingSystem)
